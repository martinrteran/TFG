...
Para simular el emisor supondremos varios materiales: \gls{si} , aceros inoxidables 304 (\acrshort{ss}) y \gls{sic}. Se utiliza \gls{si} para las pruebas de simulación iniciales para tener un punto de partida, para luego pasar al \textit{SS} por ser un material muy utilizado en la industria, incluyendo al transporte, y por último el \gls{sic} que es una cerámica que se ha utilizado para el aumento de potencia de radiación en campo cercano \cite{doi:Near_field_ThinFilm}.
\begin{figure}[H]
	\centering
