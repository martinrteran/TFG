...
\begin{figure}[H]
	...
	\label{fig:EgRad}
\end{figure}
Entre todos los materiales de emisor que se pueden observar en la figura \ref{fig:EgRad}, se seleccionan para este trabajo los siguientes tres materiales:
\begin{itemize}
...
Es un software desarrollado por Autodesk que se usa para crear simulaciones computacional de la dinámica de fluidos para la predicción del comportamiento complejo de fluidos (líquidos y gases), el programa también simula la transmisión de calor por conducción en sólidos, convección en fluidos y radiación.\\\\
%\begin{figure}[H]
	%\centering
