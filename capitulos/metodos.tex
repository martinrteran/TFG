...
\end{equation}
%%% YOVANOVICH
Para los casos en los que la resistencia de contacto es presentada como conductancia de contacto (\gls{hc}) según un modelo matemático \cite{experimental_Rc_SS}, según la ecuación de Cooper reducida por Yovanovich (ecuación \eqref{eq:modeloYovanovich}).
\begin{subequations}
\begin{equation}
