...
\label{fig:rads_SiGe}
\end{figure}
Se realiza la integral en el rango de longitudes de onda cuya energía es mayor a los 0.7 eV, obteniéndose potencias alrededor de los $10^3 \ W/m^2$ (figura \ref{fig:p_Eg_SiGe}). Para todo el rango disponible de longitudes de onda se obtiene alrededor de los $10^4 \ W/m^2$ (figura \ref{fig:p_full_SiGe}).
\begin{figure}[H]
\centering
\begin{subfigure}[b]{0.49\textwidth}
	\centering
